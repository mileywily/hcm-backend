...
class OrigenModel extends Crud
{
  ...
  const TABLE 		= 'origen'; 	// Nombre de la tabla fisica
  const IDNAMETABLE = 'origen_id'; // nombre del id de la tabla fisica
